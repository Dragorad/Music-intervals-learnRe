    ...
    return (
      ...
      >
        ...
        <div className='example'>
          <p>Задайте време за отговор между 2 и 20 секунди, брой на задачите не
            по-малък от 2 и изберете поне един интервал върху който да се
            задават въпроси.
          </p>
          <p>Всеки вид интервал включен в теста дава по 20 точки за верен отговор
          </p>
          <p>Всяка секунда отпусната за отговаряне намалява резултата за верен
            отговор с 1 точка
          </p>
        </div>
        <div className='example'>
          ...
          <p> Ако тестът включва малки секунди, малки и големи терци за всеки
